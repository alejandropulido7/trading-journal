...
import { LayoutDashboard, CalendarDays, Settings, 
  LineChart, HardDrive, Banknote, Target, Lightbulb, LogOut } from "lucide-react";
...
export default function RootLayout({
  ...
  return (
      <div className={`${inter.className} bg-gray-50 flex h-screen overflow-hidden w-full`} suppressHydrationWarning={true}>
        ...
        <aside className="w-64 bg-slate-950 text-white flex flex-col shadow-xl z-20">
          ...
          <nav className="flex-1 p-4 space-y-2">
            ...
            <Link href="/trade-ideas" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-slate-800 transition text-sm font-medium text-slate-300 hover:text-white">
              <Lightbulb size={20} />
              Trade Ideas
            </Link>
